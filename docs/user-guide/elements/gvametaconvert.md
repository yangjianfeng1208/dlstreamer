...
Element Properties:
  ...
  tags                  : User supplied JSON object of additional properties added to each frame's inference results
                          flags: readable, writable
                          String. Default: null
  timestamp-utc         : Use UTC time (drop time zone information) in system timestamps (if they were generated by the [timecodestamper](https://gstreamer.freedesktop.org/documentation/timecode/timecodestamper.html)).
                          flags: readable, writable
                          Boolean. Default: false
  timestamp-microseconds: Use microsecond precision (instead of standard milliseconds) in system timestamps (if they were generated by the [timecodestamper](https://gstreamer.freedesktop.org/documentation/timecode/timecodestamper.html)).
                          flags: readable, writable
                          Boolean. Default: false
